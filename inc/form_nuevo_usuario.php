...
<form class="form_agregar_usuario_admin" action="" method="POST" autocomplete="off">

   <div class="row">
      <div class="mb-3 col-lg-6 col-12">
         <label for="curp_ingresado" class="col-form-label">CURP</label>
         <input type="text" class="form-control" id="curp_ingresado" name="curp_ingresado" placeholder="Ingresa la CURP del usuario" maxlength="18">
      </div>
      <div class="mb-3 col-lg-6 col-12">
      ...
      <div class="mb-3 col-12">
         <label for="contraseña_ingresada" class="col-form-label">Contraseña</label>
         <input type="text" class="form-control" id="contraseña_ingresada" name="contraseña_ingresada" placeholder="Ingresa una contraseña usuario (al menos 8 caracteres)" maxlength="90">
      </div>
      ...
      <div class="modal-footer">
         ...
         <button type="submit" id="btn_enviar_form_agregar" class="btn btn-primary btn-md" data-bs-dismiss="modal">Confirmar</button>
      </div>

      <?php
      // verificamos que se mande el formulario
      include "./php/main.php";
      if ((isset($_POST['curp_ingresado']) && (!verificarDatos('[a-zA-Z0-9]{18}', $_POST['curp_ingresado']))) && (isset($_POST['nombre_ingresado']) && (!verificarDatos('[a-zA-Z]{0,100}', $_POST['nombre_ingresado']))) && (isset($_POST['academia_ingresada']) && $_POST['academia_ingresada']!="") && (isset($_POST['presea_ingresada']) && $_POST['presea_ingresada']!="") && (isset($_POST['contraseña_ingresada']) && $_POST['contraseña_ingresada']!="" && (!verificarDatos('[a-zA-Z0-9$@.-_]{8,100}', $_POST['contraseña_ingresada'])))) {
         echo '
            <script>
